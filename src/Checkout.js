                    ...
                    <div class="col-lg-8 pr-5">
                        <div class="coupon-notice " data-toggle="modal" data-target="#coupon-modal">
                            <div class="bg-light p-3">
                                Have Link coupon? <Link href="/cart" class="showcoupon" >Click here to enter your code</Link>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-check mb-4">
                                        ...
                                        <label class="form-check-label" for="exampleCheck2">Ship to Link different address?</label>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group mb-4">
