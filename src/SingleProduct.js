...
// console.log(getdata,"getdata")
  ...
  const dtaaa= ()=>{
    ...
    const html =[]
    data.map((item,key)=>{
      let variable= parseFloat(item.price) *  parseFloat(item.quentity)
      total += variable;
                  ...
                  <div class="col-md-7">
                    <div class="single-product-details mt-5 mt-lg-0">
                      ...
                      <h3 class="product-price">
                        {" "}
                        per item price: {item.price}$ <del>$119.90</del>
                      </h3>
                      <h3 class="product-price">
                        {" "}
                        total price: {total}${" "}
                      ...
                      <p class="product-description my-4 ">
                        ...
                        elit. Laborum ipsum dicta quod, quia doloremque aut
                        deserunt commodi quis. Totam a consequatur beatae
                        nostrum, earum consequuntur? Eveniet consequatur ipsum
                        dicta recusandae.
                      </p>
                      ...
                      <form class="cart" action="#" method="post">
                        ...
                        >
                          ...
                          <div variant="info" className="mr-3">
                            {/* <span onClick={item.quentity <=1 ? ()=>deleteitem(item.id):()=>deleteitem(item)}>-</span> */}
                ...
                <div class="product-wrap">
                  <a routerLink="/product-single">
                    <img
                      ...
                      src={ require("./assets/images/322.jpg")}
                      alt="product-img"
                    />
                  </a>
                  <a routerLink="/product-single">
                    <img
                      ...
                      src={ require("./assets/images/444.jpg")}
                      alt="product-img"
                    />
                  </a>
                </div>
